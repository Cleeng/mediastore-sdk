...
| `MSSDK:switch-action-cancelled`                 | `null`                                                                                   | The event will be emitted when the user resigns to switch the subscription (upgrade/downgrade). This button cancels the subscription switch process and closes an offer switch popup.                                                                                                                                                                                                                                                 |
| `MSSDK:switch-action-successful`                | `{fromOfferId: "S123456789_US", toOfferId: "S123336741_US", switchDirection: "upgrade"}` | The event will be emitted when a request to switch the subscription succeed.                                                                                                                                                                                                                                                                                                                                                          |
| `MSSDK:switch-action-failed`                    | `null`                                                                                   | The event will be emitted when a request to switch the subscription failed.                                                                                                                                                                                                                                                                                                                                                           |
