...
| `MSSDK:resume-action-cancelled`         | `null`                                                                                   | The event will be emitted after clicking confirm resume cancellation button in my account resume subcription popup. This button cancels the subscription reactivation process.                                                                                                                                                                                                                                                        |
...
| `MSSDK:update-payment-successful`       | `null`                                                                                   | The event will be emitted after successful payment method update in my account.                                                                                                                                                                                                                                                                                                                                                       |
| `MSSDK:update-payment-failed`           | `null`                                                                                   | The event will be emitted after failed payment method update in my account.                                                                                                                                                                                                                                                                                                                                                           |
| `MSSDK:remove-payment-button-clicked`   | `null`                                                                                   | The event will be emitted after clicking 'Remove your payment method' button in my account.                                                                                                                                                                                                                                                                                                                                           |
| `MSSDK:remove-payment-action-confirmed` | `null`                                                                                   | The event will be emitted after clicking Remove button in my account update payment details survey. This button removes selected payment method.                                                                                                                                                                                                                                                                                      |
| `MSSDK:remove-payment-action-cancelled` | `null`                                                                                   | The event will be emitted after clicking removal cancellation button in my account update payment details survey. This button cancels payment method removal process.                                                                                                                                                                                                                                                                 |
