...
| `MSSDK:switch-popup-action-successful`          | `{fromOfferId: "S123456789_US", toOfferId: "S123336741_US", switchDirection: "upgrade", algorithm: "DEFERRED", switchId: "S123456789_US"}` | The event will be emitted when a request to switch the subscription succeeds.                                                                                                                                                                                                                                                                                                                                                             |
