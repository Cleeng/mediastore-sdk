...
| `addTranslations`               | `translations: object`                                       | Option to provide object with custom translations. Translation keys from this object will override the keys from the default English translation object                 |
...
| `MSSDK:purchase-successful`                     | `{payment: { ...paymentResponse} }`                                                                                                                                                                 | The event will be emitted after successful payment action. For the Adyen payment `paymentResponse` object is the repsonse from [Adyen payment response](https://developers.cleeng.com/reference/adyen-initial-payment) when for Paypal it is an object with the external payment method ID.                                                                                                                                               |
