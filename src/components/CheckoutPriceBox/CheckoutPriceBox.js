    ...
    <StyledPriceBox>
      <StyledPriceBoxWrapper>
        ...
        <StyledPriceWrapper>
          <StyledLabel>
            {country === 'US'
              ? t('applicable-tax', 'Applicable Tax')
              : t('applicable-vat', 'Applicable VAT')}
          </StyledLabel>
          <StyledOfferPrice>
        ...
        {customerServiceFee !== 0 && (
          <StyledPriceWrapper>
            <StyledLabel>{t('service-fee', 'Service Fee')}</StyledLabel>
            <StyledOfferPrice>
        ...
        {paymentMethodFee !== 0 && (
          <StyledPriceWrapper>
            <StyledLabel>
              {t('payment-method-fee', 'Payment Method Fee')}
            </StyledLabel>
            <StyledOfferPrice>
